...
Utah moved from `UNDETERMINED` to `NO_AUTHORITY_CONFIRMED` with zero registry rows. Utah Constitution article XI, section 5 limits charter-city tax authority to the bounds prescribed by general law. *Moss v. Board of Commissioners of Salt Lake City*, 1 Utah 2d 60, 261 P.2d 961 (1953), holds that a municipality has only taxing power expressly conferred or necessarily implied by legislative enactment, with doubtful authority resolved for the taxpayer. Current section 10-1-203 expressly excludes employees rendering services to employers from its municipal business-tax definition and enumerates other revenue-tax subjects, not employee wages.

The complete-code audit selected and downloaded all 96 official current title PDFs—19,339 pages, 37,553,810 PDF bytes, and 56,391,062 extracted characters. It found no qualifying municipal income, wage, earnings, compensation, payroll, or withholding delegation or adopter. Every nonzero exact-phrase or proximity hit was unrelated. Section 59-10-402 and the April 2026 withholding guide administer Utah state income-tax withholding, not municipal withholding. The registry remains 2,815 municipalities across nine states. Coverage is now 17 `COMPLETE`, 20 `NO_AUTHORITY_CONFIRMED`, 10 `PARTIAL`, and 4 `UNDETERMINED`. See the [Utah closure report](../20260826T230418Z_utah-municipal-wage-tax-closure.md), [evidence directory](../20260826T230418Z_utah-municipal-wage-tax-closure-artifacts/README.md), and updated [coverage matrix](coverage-matrix.jsonl).

## August 26, 2026 South Dakota closure addendum

South Dakota moved from `UNDETERMINED` to `COMPLETE` with zero registry rows. SDCL 10-52-9 requires advance notice to the Secretary of Revenue for every new or amended chapter 10-52 municipal tax ordinance. The July 2026 DOR municipal-tax guide identifies the current municipal system and municipality codes as sales/use and gross-receipts taxes, with no employee income, wage, earnings, compensation, or payroll category or adopter.

The complete-code audit retrieved all 63 official consolidated title documents—Constitution title `0N` and codified-law titles 1 through 62—and scanned 176,375,083 bytes. It found no qualifying authorization or adopter. The only `payroll tax` hit is an unrelated PEO sales-tax deduction, and the two `local income tax` hits are generic partnership recordkeeping provisions. Broad home-rule and non-ad-valorem language remains, so the state is a current `COMPLETE` zero rather than `NO_AUTHORITY_CONFIRMED`. The registry remains 2,815 municipalities across nine states. Coverage is now 17 `COMPLETE`, 19 `NO_AUTHORITY_CONFIRMED`, 10 `PARTIAL`, and 5 `UNDETERMINED`. See the [South Dakota closure report](../20260826T230418Z_south-dakota-municipal-wage-tax-closure.md), [evidence directory](../20260826T230418Z_south-dakota-municipal-wage-tax-closure-artifacts/README.md), and updated [coverage matrix](coverage-matrix.jsonl).
...
Mississippi moved from `UNDETERMINED` to `NO_AUTHORITY_CONFIRMED` with zero registry rows. Section 21-17-5(2) requires specific state-law authorization for any municipal tax. The current municipal taxation code, the State Auditor's mandatory municipal accounting/compliance framework, current Department of Revenue withholding and special-levy systems, and a 30-regular-session legislative audit disclose no enacted municipal employee wage-tax grant.

Five bills proposed the exact authority—1997 HB 68, 1998 HB 299, 1999 HB 950, 2001 HB 900, and 2003 HB 1467—and all died in House committee. The project-specific Job Development Assessment Fee remains excluded as a Mississippi Business Finance Corporation bond assessment, not a municipal levy. The registry remains 2,815 municipalities across nine states. Coverage is now 16 `COMPLETE`, 18 `NO_AUTHORITY_CONFIRMED`, 10 `PARTIAL`, and 7 `UNDETERMINED`. See the [Mississippi closure report](../20260826T230418Z_mississippi-municipal-wage-tax-closure.md), [evidence directory](../20260826T230418Z_mississippi-municipal-wage-tax-closure-artifacts/README.md), and updated [coverage matrix](coverage-matrix.jsonl).
