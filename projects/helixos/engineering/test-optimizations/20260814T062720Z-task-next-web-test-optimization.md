...
- Exact-head full CI run `31778352981`, attempt 1, completed successfully at 2026-08-14T07:15:58Z. `web-unit`, `backend-and-infra`, and `web-e2e` passed; the path-gated `web-cross-browser` check remained skipped as designed because this PR does not change its trigger paths. The run completed in 14m 32s from `run_started_at` to `updated_at`.
- Hosted sample 1: run `31778352981`, attempt 1, job `94698495859`, runner `GitHub Actions 1000018365`, exact head `14e4f2b2469386aafb29556ddd514bee5025195c`, artifact `9211009515` (`web-unit-timing`, locally extracted at `C:\Users\bsstr\AppData\Local\Temp\helixos-pr-1148\attempt-1`). Job duration 777s; web command 581.995s; Vitest runner wall 568.845s; target total 19,472.591ms; tests/hooks 16,621.358ms; 13 passed, 0 failed, 0 skipped. Versus the hosted baseline, target total improved 22.5% and tests/hooks improved 26.8% while counts were preserved.
- Sample 2 was started by rerunning only completed `web-unit` job `94698495859`. Run `31778352981`, attempt 2, new `web-unit` job `94702050174`, runner `GitHub Actions 1000018367`, started at 2026-08-14T07:20:13Z on the unchanged exact head; no backend, end-to-end, or cross-browser work was rerun for timing collection.
- Hosted sample 2 completed successfully: run `31778352981`, attempt 2, job `94702050174`, exact head `14e4f2b2469386aafb29556ddd514bee5025195c`, artifact `9211438803` (`web-unit-timing`, locally extracted at `C:\Users\bsstr\AppData\Local\Temp\helixos-pr-1148\attempt-2`). Job duration 763s; web command 568.252s; Vitest runner wall 555.891s; target total 19,344.717ms; tests/hooks 16,429.118ms; 13 passed, 0 failed, 0 skipped. Versus the hosted baseline, target total improved 23.0% and tests/hooks improved 27.7% while counts were preserved.
- Sample 3 was started by rerunning only completed `web-unit` job `94702050174`. Run `31778352981`, attempt 3, new `web-unit` job `94705568209`, runner `GitHub Actions 1000018368`, started at 2026-08-14T07:38:02Z on the unchanged exact head.
- Hosted sample 3 completed successfully: run `31778352981`, attempt 3, job `94705568209`, exact head `14e4f2b2469386aafb29556ddd514bee5025195c`, artifact `9211879814` (`web-unit-timing`, locally extracted at `C:\Users\bsstr\AppData\Local\Temp\helixos-pr-1148\attempt-3`). Job duration 792s; web command 577.182s; Vitest runner wall 563.997s; target total 19,246.466ms; tests/hooks 16,339.861ms; 13 passed, 0 failed, 0 skipped. Versus the hosted baseline, target total improved 23.4% and tests/hooks improved 28.1% while counts were preserved.
- Hosted aggregate across three exact-head samples: job median 777s (range 763-792s); web-command median 577.182s (568.252-581.995s); Vitest-runner median 563.997s (555.891-568.845s); target-total median 19,344.717ms (19,246.466-19,472.591ms), 23.0% below the 25,118.172ms hosted baseline; tests/hooks median 16,429.118ms (16,339.861-16,621.358ms), 27.7% below the 22,719.420ms hosted baseline. Every sample preserved 13 passed, 0 failed, and 0 skipped. The full command and job were slower than the single baseline run, so the optimization claim remains scoped to the consistently faster target file; no production, workflow, build, setup, or unrelated test code changed.
- The skill-referenced `scripts/summarize_web_unit_samples.py` is absent from the repository and all fetched refs. Aggregate values were therefore calculated directly from the three artifact JSON payloads using the same median, range, and baseline-delta definitions; no repository file was added for this tooling gap.
- Final exact-head `jfollas` approval is pending.
