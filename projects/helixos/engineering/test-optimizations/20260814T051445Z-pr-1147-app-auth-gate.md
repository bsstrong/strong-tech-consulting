# HelixOS PR #1147 — Speed up application authentication gate web tests
...
- Completed/merged: 2026-08-14T05:14:45Z
- Work-start-to-merge: 1h 24m 08s
...
- Pull request: https://github.com/helixosio/helixos/pull/1147 (`Merged`; owner promoted and later merged it)
- PR created: 2026-08-14T04:05:48Z
- PR open-to-merge: 1h 08m 57s
- Implementation commit: `12c487584eb4b19f33e5d4abcd748ce03c7c0ea4`
- Merge commit: `588b156ddeea6cf5926c266f41fbab72ee3de258`
- Change size: 2 files, 78 additions, 25 deletions; one implementation commit
...
- Final GitHub review was requested only from `jfollas` and verified after the exact-current-head readiness gates passed. The owner then merged the pull request at 2026-08-14T05:14:45Z; the owner action is authoritative.
- Terminal outcome: merged with exact-head required CI green, zero private-review findings, zero public-review findings or unresolved threads, and an exact-head GitHub approval. No agent merge action was taken.

## Risk and follow-up

- Production behavior is unchanged; risk is limited to test-time fake-timer control and click-only user-event setup.
- The helper advances the unchanged production retry schedule, asserts all four requests, and restores real timers before recovery interactions.
- No tests, assertions, fixtures, interaction-sensitive seams, or coverage were removed. No follow-up is required for this optimization.
